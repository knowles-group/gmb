...
container<2,double> eom_ccsd_l1(
    ...
    container<4, double> &iw_oovv,    ///> anti-symmetrized integral <ia||bc>
    ...
    l1_new(i|a) = 
    l0*if_ov(i|a)
                + contract(e, l1(i|e), if_vv(a|e))
                - contract(m, l1(m|a), if_oo(m|i))
                - contract(e|m, l1(m|e), iw_ovov(m|a|i|e))  
                - 0.5 * contract(e|m|n, l2(m|n|a|e), iw2_ooov(m|n|i|e))
                + 0.5 * contract(e|f|m, l2(i|m|e|f), iw2_ovvv(m|a|f|e))
                + 0.5 * contract(e|f, iw2_ovvv(i|e|a|f), 
                    contract(m|n|g, l2(m|n|e|g), t2(m|n|f|g)))
                + 0.5 * contract(m|n, iw2_ooov(i|n|m|a), 
                    contract(e|f|o, l2(m|o|e|f), t2(n|o|e|f)))
                    ;
